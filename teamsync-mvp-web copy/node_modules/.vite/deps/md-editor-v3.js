import {
  markdown
} from "./chunk-SDCVAIM2.js";
import "./chunk-JCVH5YX6.js";
import "./chunk-PCVBNDYB.js";
import "./chunk-WXFASQ46.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-U4H3CXL2.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
...
var u = (e2, n2 = /* @__PURE__ */ new WeakMap()) => {
  ...
  if (e2 instanceof Map) {
    ...
    return n2.set(e2, r2), e2.forEach((o, c) => {
      r2.set(c, u(o, n2));
    }), r2;
  }
...
var R = () => {
  ...
  return (t2, r2, o, c = 100) => {
    ...
    const l = () => {
      e2 = -1;
      const a = r2 - i2;
      i2 = i2 + a / 5, Math.abs(a) < 1 ? (t2.scrollTo(0, r2), s()) : (t2.scrollTo(0, i2), e2 = requestAnimationFrame(l));
    };
...
var $ = (e2, n2 = 200) => {
  let t2 = 0, r2 = null;
  const o = (c) => {
    t2 === 0 && (t2 = c), c - t2 >= n2 ? (e2.apply(void 0, r2), r2 = null, t2 = 0) : window.requestAnimationFrame(o);
  };
  return (...c) => {
    r2 === null && window.requestAnimationFrame(o), r2 = c;
  };
};
var P = (e2) => {
  const n2 = (t2) => {
    const { scrollHeight: r2, scrollWidth: o, offsetHeight: c, offsetWidth: s, scrollLeft: i2, scrollTop: l } = e2, a = t2.x, h2 = t2.y, A = (w) => {
      const d = l + h2 - w.y, m = i2 + a - w.x, E = r2 - c, T = o - s, p = {};
      m >= 0 && m <= T && (p.left = m), d >= 0 && d <= E && (p.top = d), e2.scroll(p);
    };
...
var f = (e2) => e2 !== null && typeof e2 == "object" && !Array.isArray(e2);
var _ = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]);
var C = (e2) => !_.has(e2);
var v = (e2, n2, t2 = {}) => {
  if (Array.isArray(e2) && Array.isArray(n2))
    return y(e2, n2, t2);
  const { excludeKeys: r2 } = t2, o = e2, c = n2;
  for (const s of Object.keys(c)) {
    if (!C(s))
      continue;
    const i2 = c[s], l = o[s];
    r2 && r2(s) ? o[s] = i2 : Array.isArray(i2) && Array.isArray(l) ? o[s] = y(l, i2, t2) : f(i2) && f(l) ? o[s] = v(
      l,
      i2,
      t2
    ) : o[s] = i2;
...
var y = (e2, n2, t2) => {
  const r2 = e2.slice();
  return n2.forEach((o, c) => {
    const s = r2[c];
    Array.isArray(o) && Array.isArray(s) ? r2[c] = y(s, o, t2) : f(o) && f(s) ? r2[c] = v(
      s,
      o,
      t2
    ) : r2[c] = o;
...
var Dropdown = defineComponent({
  ...
  setup(props22, ctx) {
    ...
    const triggerHandler = () => {
      ...
      const relativecrollLeft = ((_a4 = rootNode.querySelector(props22.relative)) == null ? void 0 : _a4.scrollLeft) || 0;
...
var generateCodeRowNumber = (code2, source) => {
  if (!code2) {
    return code2;
  }
...
var MdModal = defineComponent({
  ...
  setup(props22, ctx) {
    ...
    onMounted(() => {
      var _a4;
      const rootNode = (_a4 = rootRef.value) == null ? void 0 : _a4.getRootNode();
  ...
  setup(props22, ctx) {
    ...
    const getScrollElement = () => {
      ...
      if (state.scrollElement === defaultScrollElement || props22.isScrollElementInShadow) {
        scrollRoot = (_a4 = catalogRef.value) == null ? void 0 : _a4.getRootNode();
      }
    ...
    const findActiveHeading = (list2) => {
      ...
      const {
        ...
        var _a4;
        const linkEle = (_a4 = rootNodeRef.value) == null ? void 0 : _a4.getElementById(props22.mdHeadingId(link2.text, link2.level, index2 + 1));
    ...
    const catalogChangedHandler = (_list) => {
      ...
      (_a4 = scrollContainerRef.value) == null ? void 0 : _a4.removeEventListener("scroll", scrollHandler);
...
var HistoryState = class _HistoryState {
  ...
  addChanges(event, time, userEvent, config3, tr) {
    ...
    userEvent == "input.type.compose")) {
      done = updateBranch(done, done.length - 1, config3.minDepth, new HistEvent(event.changes.compose(lastEvent.changes), conc(StateEffect.mapEffects(event.effects, lastEvent.changes), lastEvent.effects), lastEvent.mapped, lastEvent.startSelection, none));
    } else {
    ...
    for (; ; ) {
      ...
      if (norm.length)
        for (let i2 = 0, pos = start, posPrecise = true; ; i2++) {
          ...
          let match2 = this.match(code2, pos, posPrecise, this.bufferPos + this.bufferStart, i2 == norm.length - 1);
          if (match2) {
            this.value = match2;
            return this;
          }
  ...
  match(code2, pos, posPrecise, end, endPrecise) {
    ...
    for (let i2 = 0; i2 < this.matches.length; ) {
      ...
      if (this.query.charCodeAt(partial.index) == code2) {
        if (partial.index == this.query.length - 1) {
          match2 = { from: partial.from, to: end, precise: endPrecise && partial.precise };
        } else {
          partial.index++;
          keep = true;
        }
    ...
    if (this.query.charCodeAt(0) == code2) {
      if (this.query.length == 1)
        match2 = { from: pos, to: end, precise: posPrecise && endPrecise };
      else
    ...
    for (let off = this.matchPos - this.curLineStart; ; ) {
      ...
      if (match2) {
        ...
        if ((from < to || from > this.value.to) && (!this.test || this.test(from, to, match2))) {
          this.value = { from, to, precise: true, match: match2 };
          return this;
        }
...
var SearchQuery = class {
  ...
  */
  unquote(text2) {
    return this.literal ? text2 : text2.replace(/\\([nrt\\])/g, (_3, ch) => ch == "n" ? "\n" : ch == "r" ? "\r" : ch == "t" ? "	" : "\\");
  }
  /**
...
function wrapStringTest(test2, state, inner) {
  return (from, to, buffer, bufferPos) => {
    if (inner && !inner(from, to, buffer, bufferPos))
      return false;
    let match2 = from >= bufferPos && to <= bufferPos + buffer.length ? buffer.slice(from - bufferPos, to - bufferPos) : state.doc.sliceString(from, to);
    return test2(match2, state, from, to);
  };
}
function stringCursor(spec, state, from, to) {
  let test2;
  if (spec.wholeWord)
    test2 = stringWordTest(state.doc, state.charCategorizer(state.selection.main.head));
  if (spec.test)
    test2 = wrapStringTest(spec.test, state, test2);
  return new SearchCursor(state.doc, spec.unquoted, from, to, spec.caseSensitive ? void 0 : (x2) => x2.toLowerCase(), test2);
}
...
function wrapRegexpTest(test2, state, inner) {
  return (from, to, match2) => {
    return (!inner || inner(from, to, match2)) && test2(match2[0], state, from, to);
  };
}
function regexpCursor(spec, state, from, to) {
  let test2;
  if (spec.wholeWord)
    test2 = regexpWordTest(state.charCategorizer(state.selection.main.head));
  if (spec.test)
    test2 = wrapRegexpTest(spec.test, state, test2);
  return new RegExpCursor(state.doc, spec.search, { ignoreCase: !spec.caseSensitive, test: test2 }, from, to);
}
    ...
    return this.spec.unquote(this.spec.replace).replace(/\$([$&]|\d+)/g, (m, i2) => {
      ...
      for (let l = i2.length; l > 0; l--) {
        ...
        if (n2 > 0 && n2 < result.match.length)
          return result.match[n2] + i2.slice(l);
      }
      return m;
    });
  }
...
var replaceAll = searchCommand((view, { query }) => {
  ...
  for (let match2 of query.matchAll(view.state, 1e9)) {
    let { from, to, precise } = match2;
    if (precise)
      changes.push({ from, to, insert: query.getReplacement(match2) });
  }
  if (!changes.length)
    return false;
  ...
  combine(input) {
    return {
      ...
      ...combineConfig(input.map((i2) => i2.config), {
        ...
        hideOn: (a, b) => !a ? b : !b ? a : (t2, x2, y2) => a(t2, x2, y2) || b(t2, x2, y2),
        autoPanel: (a, b) => a || b
      })
    };
  }
...
function sql(dialectName) {
  return import("./dist-GXNSG7LQ.js").then((m) => m.sql({ dialect: m[dialectName] }));
}
var languages = [
  ...
  LanguageDescription.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./dist-R6FXC6KK.js").then((m) => m.cpp());
    }
  }),
  LanguageDescription.of({
    name: "C++",
  ...
  LanguageDescription.of({
    ...
    extensions: ["css"],
    load() {
      return import("./dist-H3KAZT6Z.js").then((m) => m.css());
    }
  }),
  LanguageDescription.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./dist-NTJYS3KB.js").then((m) => m.go());
    }
  }),
  LanguageDescription.of({
    name: "HTML",
    ...
    load() {
      return import("./dist-W4SGAH4S.js").then((m) => m.html());
    }
  }),
  LanguageDescription.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./dist-7XJ2I2J5.js").then((m) => m.java());
    }
  }),
  LanguageDescription.of({
    name: "JavaScript",
    ...
    load() {
      return import("./dist-HCJFBS2F.js").then((m) => m.javascript());
    }
  }),
  LanguageDescription.of({
    name: "Jinja",
    ...
    load() {
      return import("./dist-EYSUUENS.js").then((m) => m.jinja());
    }
  }),
  LanguageDescription.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./dist-UZKIVYKG.js").then((m) => m.json());
    }
  }),
  LanguageDescription.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./dist-HCJFBS2F.js").then((m) => m.javascript({ jsx: true }));
    }
  }),
  LanguageDescription.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./dist-KABAX4OM.js").then((m) => m.less());
    }
  }),
  LanguageDescription.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./dist-OZKOBUIL.js").then((m) => m.liquid());
    }
  }),
  LanguageDescription.of({
    name: "MariaDB SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-GQDWPXLH.js").then((m) => m.markdown());
    }
  }),
  LanguageDescription.of({
    name: "MS SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-VCYPJZAQ.js").then((m) => m.php());
    }
  }),
  LanguageDescription.of({
    name: "PLSQL",
  ...
  LanguageDescription.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./dist-I65PDDE5.js").then((m) => m.python());
    }
  }),
  LanguageDescription.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./dist-BNQACHDD.js").then((m) => m.rust());
    }
  }),
  LanguageDescription.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./dist-Y73PPFLO.js").then((m) => m.sass({ indented: true }));
    }
  }),
  LanguageDescription.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./dist-Y73PPFLO.js").then((m) => m.sass());
    }
  }),
  LanguageDescription.of({
    name: "SQL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./dist-HCJFBS2F.js").then((m) => m.javascript({ jsx: true, typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "TypeScript",
    ...
    load() {
      return import("./dist-HCJFBS2F.js").then((m) => m.javascript({ typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./dist-RYJBUQRY.js").then((m) => m.wast());
    }
  }),
  LanguageDescription.of({
    name: "XML",
    ...
    load() {
      return import("./dist-TLX5W4HK.js").then((m) => m.xml());
    }
  }),
  LanguageDescription.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./dist-RKHACDTV.js").then((m) => m.yaml());
    }
  }),
  ...
  LanguageDescription.of({
    ...
    extensions: ["cs"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.csharp));
    }
  }),
  LanguageDescription.of({
    name: "Clojure",
  ...
  LanguageDescription.of({
    ...
    extensions: ["dart"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.dart));
    }
  }),
  LanguageDescription.of({
    name: "diff",
  ...
  LanguageDescription.of({
    ...
    filename: /^Dockerfile$/,
    load() {
      return import("./dockerfile-2VBIDOMH.js").then((m) => legacy(m.dockerFile));
    }
  }),
  LanguageDescription.of({
    name: "DTD",
  ...
  LanguageDescription.of({
    ...
    extensions: ["factor"],
    load() {
      return import("./factor-32M2RXAJ.js").then((m) => legacy(m.factor));
    }
  }),
  LanguageDescription.of({
    name: "FCL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["kt", "kts"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.kotlin));
    }
  }),
  LanguageDescription.of({
    name: "LiveScript",
  ...
  LanguageDescription.of({
    ...
    extensions: ["lua"],
    load() {
      return import("./lua-IW7M2NO6.js").then((m) => legacy(m.lua));
    }
  }),
  LanguageDescription.of({
    name: "mIRC",
  ...
  LanguageDescription.of({
    ...
    extensions: ["nsh", "nsi"],
    load() {
      return import("./nsis-4DL4OB5N.js").then((m) => legacy(m.nsis));
    }
  }),
  LanguageDescription.of({
    name: "NTriples",
  ...
  LanguageDescription.of({
    ...
    extensions: ["m"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.objectiveC));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C++",
    ...
    extensions: ["mm"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.objectiveCpp));
    }
  }),
  LanguageDescription.of({
    name: "OCaml",
  ...
  LanguageDescription.of({
    ...
    extensions: ["p", "pas"],
    load() {
      return import("./pascal-OVFAP3TO.js").then((m) => legacy(m.pascal));
    }
  }),
  LanguageDescription.of({
    name: "Perl",
  ...
  LanguageDescription.of({
    ...
    extensions: ["q"],
    load() {
      return import("./q-UJS662OT.js").then((m) => legacy(m.q));
    }
  }),
  LanguageDescription.of({
    name: "R",
  ...
  LanguageDescription.of({
    ...
    extensions: ["scala"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.scala));
    }
  }),
  LanguageDescription.of({
    name: "Scheme",
  ...
  LanguageDescription.of({
    ...
    extensions: ["nut"],
    load() {
      return import("./clike-AGD4SWXR.js").then((m) => legacy(m.squirrel));
    }
  }),
  LanguageDescription.of({
    name: "Stylus",
    extensions: ["styl"],
    load() {
      return import("./stylus-MATZI74A.js").then((m) => legacy(m.stylus));
    }
  }),
  LanguageDescription.of({
    name: "Swift",
  ...
  LanguageDescription.of({
    ...
    extensions: ["toml"],
    load() {
      return import("./toml-4SIJKLTD.js").then((m) => legacy(m.toml));
    }
  }),
  LanguageDescription.of({
    name: "Troff",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./xquery-PLUQILSF.js").then((m) => legacy(m.xQuery));
    }
  }),
  LanguageDescription.of({
    name: "Yacas",
  ...
  LanguageDescription.of({
    ...
    extensions: ["vue"],
    load() {
      return import("./dist-MKW4EMLP.js").then((m) => m.vue());
    }
  }),
  LanguageDescription.of({
    name: "Angular Template",
    load() {
      return import("./dist-X2RTXJ7I.js").then((m) => m.angular());
    }
  })
];
...
function isPunctCharCode(code2) {
  return isPunctChar(fromCodePoint3(code2));
}
  ...
  for (let i2 = 0; i2 < tokens.length; i2++) {
    ...
    OUTER:
      while (pos < max) {
        ...
        if (!canOpen && !canClose) {
          if (isSingle) {
            addReplacement(replacements, i2, t2.index, APOSTROPHE);
          }
          continue;
        }
        if (canClose) {
          for (j = stack.length - 1; j >= 0; j--) {
            ...
            if (item.single === isSingle && stack[j].level === thisLevel) {
              ...
              addReplacement(replacements, i2, t2.index, closeQuote);
...
function html_block(state, startLine, endLine, silent) {
  ...
  let nextLine = startLine + 1;
  const endsOnBlankLine = HTML_SEQUENCES[i2][1].test("");
...
function r(t2, r2) {
  r2 = r2 || {}, t2.core.ruler.before("linkify", "image_figures", function(s) {
    ...
    for (let o = 1, c = s.tokens.length; o < c - 1; ++o) {
      ...
      const f2 = s.tokens[o - 1];
      let h2;
      if (f2.type = "figure_open", f2.tag = "figure", s.tokens[o + 1].type = "figure_close", s.tokens[o + 1].tag = "figure", r2.dataType && s.tokens[o - 1].attrPush(["data-type", "image"]), r2.link && 1 === l.children.length) {
        [h2] = l.children;
      ...
      if (r2.copyAttrs && h2.attrs) {
        ...
        f2.attrs = h2.attrs.filter(([e2]) => e2.match(t3)).map((t4) => Array.from(t4));
      }
...
evict_fn = function(free) {
  ...
  if (__privateGet(this, _hasFetchMethod) && __privateMethod(this, _LRUCache_instances, isBackgroundFetch_fn).call(this, v2)) {
    ...
    if (__privateGet(this, _hasDisposeAfter)) {
      (_b2 = __privateGet(this, _disposed)) == null ? void 0 : _b2.push([v2, k2, "evict"]);
    }
  }
    ...
    if (index2 !== void 0) {
      ...
      if (__privateGet(this, _size) === 1) {
        ...
        if (__privateMethod(this, _LRUCache_instances, isBackgroundFetch_fn).call(this, v2)) {
          ...
          if (__privateGet(this, _hasDispose)) {
            (_a4 = __privateGet(this, _dispose)) == null ? void 0 : _a4.call(this, v2, k2, reason);
          }
          if (__privateGet(this, _hasDisposeAfter)) {
            (_b2 = __privateGet(this, _disposed)) == null ? void 0 : _b2.push([v2, k2, reason]);
          }
        }
        __privateGet(this, _keyMap).delete(k2);
          ...
          const handler = async (item) => {
            ...
            if (!mermaidHtml) {
              ...
              try {
                ...
                (_a4 = p.children[0]) == null ? void 0 : _a4.removeAttribute("height");
...
var MermaidPlugin = (md, options) => {
  ...
  md.renderer.rules.fence = (tokens, idx, ops, env, slf) => {
    ...
    if (token.info === "mermaid") {
      ...
      const mermaidHtml = mermaidCache.get(code2);
      if (mermaidHtml) {
  ...
  for (var i2 = 0; i2 < len; i2++) {
    ...
    if (/\s|\n|\t/.test(c)) {
      ...
      if (tmpName === false) {
        ...
        if (j === -1) {
          v2 = _$1.trim(html.slice(lastPos, i2));
          addAttr(v2);
          tmpName = false;
          lastPos = i2 + 1;
          continue;
...
function getAttrs(html) {
  ...
  html = _2.trim(html.slice(i2 + 1, -1));
  var isClosing2 = html[html.length - 1] === "/";
  if (isClosing2) html = _2.trim(html.slice(0, -1));
  return {
    html,
    closing: isClosing2
  };
...
var useMarkdownIt = (props8, previewOnly) => {
  ...
  watch(
    ...
    x(markHtml, previewOnly ? 0 : editorConfig.renderDelay)
  );
  watch(
...
var useTaskState = (props8, html) => {
  ...
  const addListener = () => {
    ...
    const listener = (e2) => {
      ...
      const line = (_a4 = e2.target.parentElement) == null ? void 0 : _a4.dataset.line;
      if (!line) {
        return;
      }
...
var useConfig = (props8, context) => {
  ...
  const updateSetting = (k2, v2) => {
    const realValue = v2 === void 0 ? !setting[k2] : v2;
    switch (k2) {
      case "preview": {
...
var useExpose$1 = (props8, ctx, catalogVisible, setting, updateSetting, codeRef) => {
  ...
  const exposeParam = {
    ...
    getEditorView() {
      var _a4;
      return (_a4 = codeRef.value) == null ? void 0 : _a4.getEditorView();
    }
  };
...
var TableShape = defineComponent({
  ...
  setup(props22) {
    ...
    }, [new Array(tableShape.value[1]).fill("").map((_3, rowIndex) => createVNode("div", {
...
var ToolBar = defineComponent({
  ...
  setup(props22) {
    ...
    const barRender = (barItem) => {
      var _a4, _b2, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W, _X, _Y, _Z, __, _$, _aa, _ba, _ca, _da, _ea, _fa, _ga, _ha, _ia, _ja, _ka, _la, _ma, _na, _oa, _pa, _qa, _ra, _sa, _ta, _ua, _va, _wa;
    ...
    return () => {
      ...
      return createVNode(Fragment, null, [props22.toolbars.length > 0 && createVNode("div", {
        ...
        "aria-label": (_a4 = ult.value.imgTitleItem) == null ? void 0 : _a4.upload
...
var useAutoScroll = (props22, html, codeMirrorUt) => {
  ...
  const rebindEvent = () => {
    var _a4;
    clearScrollAuto();
    const rootNode = (_a4 = codeMirrorUt.value) == null ? void 0 : _a4.view.contentDOM.getRootNode();
...
var directive2flag = async (direct, codeMirrorUt, params) => {
  ...
  if (/^h[1-6]{1}$/.test(direct)) {
    const pix = direct.replace(/^h(\d)/, (_3, num) => {
      ...
      async callback(direct, params = {}) {
        ...
        if (direct === "image" && params.transform) {
          ...
          if (tv instanceof Promise) {
            tv.then(async (url) => {
              var _a22;
              const { text: text2, options } = await directive2flag(
                direct,
                codeMirrorUt.value,
                {
                  ...params,
      ...
      callback: $((handlers) => {
        ...
        for (const eventName in handlers) {
          ...
          if (defaultEventNames.includes(en)) {
            nextDomEventHandlers[en] = (e2, v2) => {
              handlers[en](e2, v2);
              if (!e2.defaultPrevented) {
                domEventHandlers[en](e2, v2);
              }
            };
          } else {
...
var Content = defineComponent({
  ...
  setup(props22, ctx) {
    ...
    ctx.expose({
      ...
      getEditorView() {
        var _a4;
        return (_a4 = codeMirrorUt.value) == null ? void 0 : _a4.view;
      }
    });
    return () => {
      return createVNode("div", {
  ...
  setup(props22, ctx) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "scrollAuto": state.scrollAuto,
        "onScrollAutoChange": (v2) => state.scrollAuto = v2
      }, null)]);
    };
  }
});
